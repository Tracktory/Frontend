...
export const REMAINING_PREVIEW_COUNT = 5;

interface CompetencyCoverageBlockProps {
...
export function CompetencyCoverageBlock({
  roadmap,
  completedCourses,
  showReportCta = false,
  onShowReport,
}: CompetencyCoverageBlockProps) {
